...
public class CartActivity extends AppCompatActivity implements CartTouchButtonListener {
    ...
    TextView totalCart_OPrice, totalCart_SPrice,btn_CartDelivery,cart_Empty;
    ...
    String[] choose = {"Payment upon delivery","Bank transfer"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = findViewById(R.id.cartLinear);
        view = findViewById(R.id.cart_view);
        iconCart = findViewById(R.id.cartImg);
        cart_Empty = findViewById(R.id.txt_cart_empty);

        DatabaseReference cartReference = FirebaseDatabase.getInstance().getReference().child("cart").child(user.getUid());
        ...
        cartReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    btn_CartDelivery.setVisibility(View.GONE);
...
//        if (!FirebaseDatabase.getInstance().getReference().child("cart").child(user.getUid()).equals("null")){
//            cart_Empty.setVisibility(View.VISIBLE);
//            iconCart.setVisibility(View.GONE);
//            view.setVisibility(View.GONE);
//            btn_CartDelivery.setVisibility(View.GONE);
//            linearLayout.setVisibility(View.GONE);
//            Log.d(TAG, "onCreate: nulllllll");
//        }
//        else{
                ...
                public void onClick(View v) {
                    ...
                    paymentMethod.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            if ( parent.getItemAtPosition(position) == "Bank transfer"){
                    ...
                    btn_confirmDelivery.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            else if(TextUtils.isEmpty(bankNumber) && bankchoose == "Bank transfer"){
                                Log.e(TAG, "daasdasdas: sent todayu");
                                Toast.makeText(getApplicationContext(), "Please select the bank you want to transfer to!",Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            FirebaseDatabase.getInstance().getReference().child("booking")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(getApplicationContext(),"Your order is on its way to you", Toast.LENGTH_SHORT).show();
                                            dialogPlus.dismiss();
                                            clearCart();
        ...
        cartReference.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Log.d(TAG, "Cart da clear ");
//                    Toast.makeText(getApplicationContext(), "Xóa thành công", Toast.LENGTH_SHORT).show();
                } else {
                    Log.d(TAG, "onComplete: Cart xoa bi lkoi");
