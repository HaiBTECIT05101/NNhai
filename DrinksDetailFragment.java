...
public class DrinksDetailFragment extends Fragment implements ItemClickListener, SugarCheckboxListenner, IceCheckboxListenner {
    ...
    double rating;
    String drinksExtras_sugar= "product",drinksExtras_size= "color",drinksExtras_ice = "version" ;
        ...
        if (bundle != null) {
            ...
            mDatabase.child("drinks").child(data).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        Log.d(TAG, "onDataChange: Ear toning");
                    ...
                    drinksDetail_sold.setText(String.valueOf(sold_count)+" sold");
                    drinksDetail_rating.setText("Evaluate: "+String.valueOf(rating)+"/5");
                    ...
                    if(sale == 1){
                        ...
                        Log.d(TAG, "onDataChange: No heart " + data);
                    }
                ...
                public void onClick(View view) {
                    ...
                    FirebaseDatabase.getInstance().getReference("cart").child(user.getUid())
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    for (DataSnapshot cartsnapshot : snapshot.getChildren()){
                                        ...
                                        if (cartid_drinksId != null && cartid_drinksId.equals(data)){
                                            ...
                                            lable_addtoCart.setText("Products already in the cart");
                                            break;
                                        }
                                        else{
                                ...
                                @Override
                                public void onCancelled(@NonNull DatabaseError error) {
                                    Log.d(TAG, "The comparison statement failed");
                                }
                            });
                    drinks_name.setText(name);
                    drinks_sold.setText("Sold: "+String.valueOf(sold_count));
                    drinks_rating.setText("Evaluate: "+String.valueOf(rating)+"/5");
            ...
            Log.d(TAG, "Haven't received data yet");
        }
        ...
        FirebaseDatabase.getInstance().getReference().child("cart").child(user.getUid()).push()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(getContext(), "Add to cart failed!", Toast.LENGTH_SHORT).show();;
                    }
                });
    ...
    public void onClickItem(long price, String name) {
        ...
        Log.d(TAG, "Price is sent to fragment: "+ price);
